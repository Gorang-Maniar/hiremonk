							...
							<span class="four_fifth" style="margin-bottom: 0; margin-top: 11px;">
								...
								?>
									...
									<span style="margin-right: 20px; float: left;">
										<input type="radio" class='' name='wpjobus_job_type' style="width: 10px; margin-right: 5px; float: left; margin-top: 5px; margin-bottom: 10px;" value='<?php echo $redux_demo['job-type'][$i]; ?>' <?php if (!empty($wpjobus_job_type)) { ?>checked="checked"<?php } ?>/><?php echo $redux_demo['job-type'][$i]; ?>
									</span>
								<?php 
									}
								?>
