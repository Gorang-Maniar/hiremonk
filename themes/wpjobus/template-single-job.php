...
$wpjobus_job_email = esc_url(get_post_meta($post->ID, 'wpjobus_job_email',true));
			...
			<div class="admin-settings-header-top">
				...
				<div class="container">
					...
					<div class="one_fifth">
						...
						<span><?php _e( 'Expires on:', 'agrg' ); ?> <?php $wpjobus_post_exp = esc_attr(get_post_meta($this_post_id, 'wpjobus_featured_expiration_date',true)); echo $time = date("m/d/Y", $wpjobus_post_exp); ?></span>
